                ...
                <div className="overflow-x-auto">
                    <Table>
                        <Table.Head className='border-b text-black'>
                            ...
                            <Table.HeadCell className='font-black'>Story</Table.HeadCell>
                            ...
                            {datas.map(courses => (
                                <Table.Row key={courses._id} className="bg-white dark:border-gray-700 dark:bg-gray-800 text-black">
                                    <Table.Cell className="whitespace-normal font-normal text-black dark:text-white">
                                        {courses.mainTopic.toUpperCase()}
                                    </Table.Cell>
                                    <Table.Cell style={{ maxLines: 2 }} className="whitespace-normal font-normal text-black dark:text-white text-ellipsis"> {getPlainText(courses.type)}</Table.Cell>
