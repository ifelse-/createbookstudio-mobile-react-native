...
const DeletionEdit = () => {
    ...
    const [terms, setTerms] = useState(sessionStorage.getItem('delete'));
    ...
    async function saveTerms() {
        ...
        const response = await axios.post(postURL, { data: terms, type: 'delete' });
        if (response.data.success) {
            sessionStorage.setItem('delete', terms);
    ...
    return (
        <div>
            <div className='flex flex-row'>
                <h1 className='text-black font-black text-3xl p-4'>Account Deletion</h1>
            ...
            <div className="textarea-container">
                <textarea
                    placeholder='Write your account deletion here in HTML format'
